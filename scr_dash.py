...
metrics_data = [
    ...
    {"name": "Inventory location accuracy rate",       "primary_stage": "Prepare", "capabilities": ["Visibility", "Efficiency", "Knowledge Management"],                          "category": "Operational"},
    {"name": "Real-time tracking coverage",            "primary_stage": "Prepare", "capabilities": ["Visibility", "Agility", "Security"],                                         "category": "Operational"},
    {"name": "Supply chain event detection rate",      "primary_stage": "Prepare", "capabilities": ["Anticipation", "Visibility", "Knowledge Management"],                        "category": "Operational"},
    {"name": "Stock availability rate",                "primary_stage": "Absorb",  "capabilities": ["Redundancy", "Efficiency", "Visibility"],                                    "category": "Operational"},
    {"name": "Supplier defect rate",                   "primary_stage": "Prevent", "capabilities": ["Efficiency", "Risk Management Culture", "Knowledge Management"],             "category": "Operational"},
    {"name": "Customer wait time for org maintenance", "primary_stage": "Recover", "capabilities": ["Efficiency", "Visibility", "Redundancy"],                                    "category": "Operational"},
    {"name": "On-time definitive delivery compliance", "primary_stage": "Absorb",  "capabilities": ["Efficiency", "Agility"],                                                     "category": "Operational"},
    {"name": "Not mission capable supply backorders",  "primary_stage": "Absorb",  "capabilities": ["Efficiency", "Agility", "Visibility"],                                       "category": "Operational"},
    {"name": "Wholesale supply availability",          "primary_stage": "Absorb",  "capabilities": ["Efficiency", "Visibility", "Redundancy"],                                    "category": "Operational"},
    {"name": "Procurement lead variance",              "primary_stage": "Prevent", "capabilities": ["Anticipation", "Organization", "Agility"],                                   "category": "Operational"},
    # --- Structural Resilience ---
    {"name": "Network concentration risk",             "primary_stage": "Prevent", "capabilities": ["Risk Management Culture", "Redundancy", "Anticipation"],                    "category": "Structural"},
    {"name": "Alternate source coverage",              "primary_stage": "Prevent", "capabilities": ["Flexibility in Sourcing and Capacity", "Redundancy", "Market Position"],    "category": "Structural"},
    {"name": "Multi-path logistics coverage",          "primary_stage": "Prevent", "capabilities": ["Redundancy", "Agility", "Visibility"],                                       "category": "Structural"},
    {"name": "Supplier financial risk score",          "primary_stage": "Prevent", "capabilities": ["Financial Strength", "Risk Management Culture", "Anticipation"],            "category": "Structural"},
    {"name": "Design lock-in severity",                "primary_stage": "Prevent", "capabilities": ["Innovation", "Flexibility in Sourcing and Capacity", "Risk Management Culture"], "category": "Structural"},
    {"name": "Critical skill and capability coverage", "primary_stage": "Prepare", "capabilities": ["HR Management", "Knowledge Management", "Organization"],                    "category": "Structural"},
    {"name": "Demand volatility",                      "primary_stage": "Prepare", "capabilities": ["Anticipation", "Knowledge Management", "Visibility"],                       "category": "Structural"},
    # --- Functional Resilience ---
    {"name": "Demand forecast accuracy",               "primary_stage": "Prevent", "capabilities": ["Anticipation", "Organization"],                                             "category": "Functional"},
    {"name": "Procurement cycle time",                 "primary_stage": "Prevent", "capabilities": ["Efficiency", "Agility", "Organization"],                                    "category": "Functional"},
    {"name": "Time-to-survive",                        "primary_stage": "Absorb",  "capabilities": ["Redundancy", "Risk Management Culture", "Anticipation"],                    "category": "Functional"},
    {"name": "Time-to-recover",                        "primary_stage": "Recover", "capabilities": ["Agility", "Organization", "Redundancy"],                                    "category": "Functional"},
    {"name": "Recovery effectiveness rate",            "primary_stage": "Recover", "capabilities": ["Risk Management Culture", "Organization", "Agility"],                       "category": "Functional"},
    {"name": "Time-to-recover improvement",            "primary_stage": "Adapt",   "capabilities": ["Knowledge Management", "Agility", "Organization", "Innovation"],            "category": "Functional"},
]
